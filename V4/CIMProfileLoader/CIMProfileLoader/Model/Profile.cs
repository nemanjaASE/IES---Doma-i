...
namespace FTN.ESI.SIMES.CIM.Model
{
    ...
    public class Profile
    {
        ...
        public int ClsCnt { get => clsCnt; set => clsCnt = value; }
        public int AtrCnt { get => atrCnt; set => atrCnt = value; }
        ...
        public override string ToString()
        {
            ...
            return toStringBuilder.ToString() + "Broj klasa: " + this.clsCnt + " Broj atributa: " + this.atrCnt;
        }
